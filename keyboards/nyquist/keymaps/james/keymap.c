...
[_QWERTY] = KEYMAP( \
  ...
  MT(KC_LSFT, LGUI(KC_D)), KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT , \
  MT(KC_LCTL, KC_HOME), MT(ADJUST, KC_PGDN),  MT(KC_LALT ,KC_PGUP), MT(KC_LGUI, KC_END), LOWER,   KC_SPC,  KC_SPC,  RAISE,   MT(ADJUST, KC_LEFT),  MT(KC_RALT, KC_DOWN), MT(KC_RSFT, KC_UP), MT(KC_RCTRL, KC_RGHT) \
),
 ...
 * |      |      |      |  M3  |      |      |   |     |      |      |      |      |      |
 * |------+------+------+------+------+------+   +-----+------+------+------+------+------|
 * |      | WhlUp| RClck| MUp  | LClck|      |   |     |   -  |   ▲  |   +  |   \  |      |
 * |------+------+------+------+------+------+   +-----+------+------+------+------+------|
 * |      | WhlDn|  MLft| MDn  | MRht |      |   |  [  |   ◀  |   ▼  |   ▶  |   ]  | Alt  |
 * |------+------+------+------+------+------+   +-----+------+------+------+------+------|
 * |      |      |      |      |      |      |   |     |      |      |      |      |      |
 * |------+------+------+------+------+------+   +-----+------+------+------+------+------|
 * |      |      |      |      |      |      |   |     |      |      |      |      |      |
 ...
 */
[_RAISE] = KEYMAP( \
  _______,  _______,  KC_BTN3,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______, \
  _______,  KC_WH_U,  KC_BTN2,    KC_MS_U,    KC_BTN1,    _______,    _______,    KC_MINS,    KC_UP,      KC_EQL,    KC_BSLS,    _______, \
  _______,  KC_WH_D,  KC_MS_L,    KC_MS_D,    KC_MS_R,    _______,    KC_LBRC,    KC_LEFT,    KC_DOWN,    KC_RIGHT,  KC_RBRC,    KC_RCTRL, \
  _______,  _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______, \
  _______,  _______,  _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,    _______,   _______ \
),
 ...
 */
[_ADJUST] =  KEYMAP( \
  QWERTY,   COLEMAK,   UPKEEP, _______,  _______, _______, _______,   _______,  _______,   _______,  _______,  _______, \
  _______, KC_F1,     KC_F2,   KC_F3,   KC_F4, RGB_HUI, _______, _______,  KC_PGUP, _______, _______, _______, \
